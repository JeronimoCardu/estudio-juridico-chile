...
const reasons = [
  {
    ...
    description: "Entendemos que el tiempo es un factor crítico en asuntos legales complejos.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Reportes claros y comunicación constante sobre el estado de sus trámites.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "Su caso siempre será gestionado por socios expertos, no por pasantes.",
  },
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
    ...
    description: "No solo diagnosticamos problemas, diseñamos rutas estratégicas de salida.",
  },
];

export default function WhyUs() {
  return (
    <section className="bg-primary py-16 lg:py-24 px-6 lg:px-30">
      <div className="text-center mb-12 lg:mb-16">
        <h2 className={`text-3xl sm:text-4xl lg:text-5xl text-white ${geistMono.className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {reasons.map((reason) => (
          ...
          >
            ...
            <h3 className={`text-white text-xl font-bold ${geistMono.className}`}>
              {reason.title}
            </h3>
